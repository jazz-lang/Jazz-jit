...
fn emit_vex2_byte1(asm: &mut Assembler,
                   reg: XMMRegister,
                   v: XMMRegister,
                   l: VectorLength,
                   pp: SIMDPrefix) {
...
fn emit_vex_prefixf(asm: &mut Assembler,
                    reg: XMMRegister,
                    vreg: XMMRegister,
                    rm: XMMRegister,
                    l: VectorLength,
...
fn evex_prefix(asm: &mut Assembler,
               vex_r: bool,
               vex_b: bool,
               vex_x: bool,
               evex_r: bool,
...
fn emit_vex_prefixr(asm: &mut Assembler,
                    reg: Register,
                    vreg: Register,
                    rm: Register,
                    l: VectorLength,
...
fn emit_vex_prefixfm(asm: &mut Assembler,
                     reg: XMMRegister,
                     vreg: XMMRegister,
                     rm: Mem,
                     l: VectorLength,
...
avx_instr!(vsubss,
           ...
           LeadingOpcode::k0F,
           VexW::W0);
avx_instr!(vsubps, 0x5c, SIMDPrefix::None, LeadingOpcode::k0F, VexW::W0);
avx_instr!(vmulpd,
           0x59,
           SIMDPrefix::k0x66,
           LeadingOpcode::k0F,
           VexW::W0);
avx_instr!(vmulps, 0x59, SIMDPrefix::None, LeadingOpcode::k0F, VexW::W0);
avx_instr!(vmulss,
           0x59,
           SIMDPrefix::k0xf3,
           LeadingOpcode::k0F,
...
avx_instr!(vdivpd,
           ...
           LeadingOpcode::k0F,
           VexW::W0);
avx_instr!(vdivps, 0x5e, SIMDPrefix::None, LeadingOpcode::k0F, VexW::W0);
avx_instr!(vdivss,
           0x5e,
           SIMDPrefix::k0xf3,
           LeadingOpcode::k0F,
